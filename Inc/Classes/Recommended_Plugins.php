...
use JLTWPFOLIO\Libs\Recommended;
	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'edit.php?post_type=portfolio',       // Ex. wp-portfolio-gallery-settings /  edit.php?post_type=page .
				__( 'Recommended', 'wp-portfolio-gallery' ),
				__( 'Recommended', 'wp-portfolio-gallery' ),
				'manage_options',
				'wp-portfolio-gallery-recommended-plugins',
