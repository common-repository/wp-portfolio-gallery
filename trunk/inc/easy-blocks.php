...
if ( is_plugin_active( 'elementor/elementor.php' ) ) {
    jeweltheme_wp_portfolio_gallery_admin_notice_requires();
}

function jeweltheme_wp_portfolio_gallery_admin_notice_requires(){

	include( plugin_dir_path( __FILE__ ) . 'class-tgm-plugin-activation.php');

	add_action( 'tgmpa_register', 'jeweltheme_wp_portfolio_gallery_register_required_plugins' );
}


function jeweltheme_wp_portfolio_gallery_register_required_plugins(){
